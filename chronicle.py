...
async def handle_special_message(event):
    if event.message.message == "Get Dns":
        edits_suck = [
            ...
            "Pinging. . .✔️", "<b>Shekan | شکن\n✅178.22.122.100 - </b><b>185.51.200.2</b>\n<i>ping: 21ms</i>✔️\n<b>\nElectro| الکترو</b>\n<b>78.157.42.100</b><b> - 78.157.42.101</b>✅\n<i>ping: 20ms</i>✔️\n\n<b>Google | گوگل\n</b><b>8.8.8.8</b><b>  -  8.8.4.4✅</b>\n<i>ping: 34ms</i>✔️\n\n<b>OpenDNS | اوپن دی ان اس\n</b><b>208.67.220.222</b><b> - </b><b>208.67.222.222</b>\n<i>ping: 29ms</i>✔️\n\n<b>Self Created By Senpia</b>🪡",
        ]
